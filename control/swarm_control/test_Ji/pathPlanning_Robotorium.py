...
def createMap():
	...
	map = np.matrix([[-wallRange,-wallRange,wallRange,-wallRange],[wallRange,-wallRange,wallRange,wallRange+0.6],\
						...
						[2.0,0.3,3.0,0.3],[1.0,3.6,1.0,3.0],[1.0,2.0,1.0,-1.5],[1.0,-2.5,1.0,-3.0],\
						[-1.0,3.0,1.0,3.0],[-1.0,2.0,1.0,2.0],[-1.0,-1.5,1.0,-1.5],[-1.0,-2.5,1.0,-2.5]\
						[-1.0,3.6,-1.0,3.0],[-1.0,2.0,-1.0,-1.5],[-1.0,-2.5,-1.0,-3.0]])
	return map
